...
public class CloseStageHandler implements EventHandler<WindowEvent> {
	...
	/**
	 * Enregistre les évènements du calendrier dans un fichier
	 */
	@Override
	...
	/**
	 * Repertorie l'intégralité des evenement de l'agenda dans une 
	 * chaine de caractere
	 * @return l'integralité des évenements du calendrier sous forme de chaine de caractère
	 */
