...
public class NewEventHandler implements EventHandler<ActionEvent> {
	...
	Popup p = new Popup();
	/**
	 * affiche une popup au centre de l'écran et instancie un controleur qui
	 * enregistre les informations pour créer un nouvel événement et l'ajouter 
	 * au calendrier de notre herbier 
	 * @param herbier 
	 */
	public void affichePopupAddEvent(Herbier herbier) {
		...
		//instancie le controlleur qui utilisera les informations obtenu 
		//avec la popup
